...
class TestCityAnnuityCalc():
    def test_city_annuity_chp_calc1(self):
        ...
        assert dem_rel_annuity - (payment_gas + payment_electr + eeg_payment)\
               <= 0.001 * dem_rel_annuity
        ...
        #  Assert proceedings
        assert proc_rel_annuity - (tax_exception + chp_subsidy) <= \
               0.001 * proc_rel_annuity
