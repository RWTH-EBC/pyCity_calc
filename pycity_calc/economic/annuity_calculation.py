...
class EconomicCalculation(object):
    ...
    def __init__(self, time=10, interest=0.05,
                 method='vdi2067',
    ...
    #  Todo: Erase, as it has been added as dublicate of city_economic_calc.py
    # def calc_cap_rel_annuity_city(self, city_object, cost_spe=False,
    #                               th_pow_ref=None):
    #     """
    ...
    #         City object
    #     cost_spe : Boolean
    #         Declare if specific costs should be considered has uncertain and b
    #         e rescaled
    #     th_pow_ref: dict
    #         If different from None: Take this maximum thermal power to
    #         calculate lhn specific costs
    #
    #     Returns
    #     -------
    #     tup_res : tuple
    ...
    #  Todo: Move to city_economic_calc.py
    ...
    #  #  Proceedings
    #  #################################################################
    #  TODO: Add method to calculate annuity of proceedings
    ...
    #  TODO: Erase, as it is duplicate of city_economic_calc.py
