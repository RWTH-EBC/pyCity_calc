...
def run_example_city_energy_balance_and_annuity_calc():
    ...
    city.node[1005]['entity'].bes.boiler.qNominal *= 5
    city.node[1005]['entity'].bes.tes.capacity *= 5
    city.node[1012]['entity'].bes.boiler.qNominal *= 5
    city.node[1012]['entity'].bes.tes.capacity *= 5
    city.node[1009]['entity'].bes.electricalHeater.qNominal *= 5
